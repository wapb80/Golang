...
import (
	...
	"log"
	"net/http"
	"postgres_internalInterfaceTempl/internal/models"
...
// NewUserHandler crea un nuevo controlador de usuarios.
func NewUserHandler(userService *service.UserService, templates *template.Template) *UserHandler {
	return &UserHandler{userService: userService, templates: templates}
}
...
func (h *UserHandler) GetAllUsers(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.templates.ExecuteTemplate(w, "layout", users); err != nil {
